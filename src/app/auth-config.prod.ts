...
export const msalConfig: Configuration = {
  auth: {
    ...
    redirectUri: '/bora-bora-ai-spa/', // Points to window.location.origin by default. You must register this URI on Microsoft Entra admin center/App Registration.
    postLogoutRedirectUri: '/bora-bora-ai-spa/', // Points to window.location.origin by default.
